...
var DGTWidgetChooser = Class.create();
DGTWidgetChooser.prototype = {
...
var DGTLayoutPreview = Class.create();
DGTLayoutPreview.prototype = {
    MAX_COLUMN: 12,
    COLUMN_WIDTH: 50,
    TITLES: new Hash(),
    ...
    renderFlexGridItem: function(item){
        ...
        var columnElm = new Element('span', {'class':'flex-grid-number'});
    ...
    bindFlexGridEvent: function(){
        ...
        items.resizable({
            ...
            resize: function(ev, ui){
                ...
                ui.element.find('.flex-grid-number').text(column);
