...
if(typeof DGT == "undefined"){
    ...
    DGT.Widget.prototype = {
        ...
        onParallaxEvent: function(element){
        ...
        onYoutubeAPIReady: function(videoId, config){
            ...
            Event.observe(muteBtn, 'click', function(ev){
                ...
                if (this.player.isMuted()){
                    this.player.unMute();
                    btn.addClassName(this.DGT_MUTE_BTN_CLASS_ON);
                    btn.removeClassName(this.DGT_MUTE_BTN_CLASS_OFF);
                }else{
                    btn.addClassName(this.DGT_MUTE_BTN_CLASS_OFF);
                    btn.removeClassName(this.DGT_MUTE_BTN_CLASS_ON);
                    this.player.mute();
                }
            }.bind(this));
        ...
        calculateVideoSize: function(container){
            var $container = $(container),
                ...
                height = parseInt(dimensions.width * this.RIT_VIDEO_HW_RATIO),
        ...
        addVideoMuteButton: function(container, muted){
            ...
            var btn = new Element('i', {
                'class': this.DGT_MUTE_BTN_CLASS,
                href: 'javascript:void(0)'
            });

            if (muted) btn.addClassName(this.DGT_MUTE_BTN_CLASS_OFF);
            else btn.addClassName(this.DGT_MUTE_BTN_CLASS_ON);
