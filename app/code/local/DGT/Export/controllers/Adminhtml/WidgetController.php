...
?>
<?php
class DGT_Export_Adminhtml_WidgetController extends Mage_Adminhtml_Controller_Action
{
        ...
        if(!is_array($instanceIds)) {
            ...
            try {
                ...
                foreach ($collection as $instance) {
                    $xml.= '<instance>';
                    $xml.= '<title>'.htmlspecialchars($instance->getTitle()).'</title>';
