...
class DGT_Widget_Model_Widget_Source_Tab_Mode{
    public function toOptionArray(){
        return array(
            ...
            //array('value' => 'specificed', 'label' => Mage::helper('dgtwidget')->__('Specified Products')),
            ...
            //array('value' => 'up', 'label' => Mage::helper('dgtwidget')->__('Up-sell Products')),
            //array('value' => 'cross', 'label' => Mage::helper('dgtwidget')->__('Cross-sell Products')),
