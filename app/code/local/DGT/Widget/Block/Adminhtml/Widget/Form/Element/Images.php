...
class DGT_Widget_Block_Adminhtml_Widget_Form_Element_Images
    ...
    public function __construct(){
        parent::__construct();
        $this->setTemplate('dgt/widget/adminhtml/widget/form/element/images.phtml');
    }
    ...
    protected function _beforeToHtml(){
        $addBtn = $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
            'label'     => Mage::helper('dgtwidget')->__('Add Image'),
