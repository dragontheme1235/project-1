...
class DGT_Filter_Model_Layer_Filter_Price extends Mage_Catalog_Model_Layer_Filter_Price{
    ...
    protected function _getResource(){
        if (is_null($this->_resource)) {
            $this->_resource = Mage::getResourceModel('dgtfilter/layer_filter_price');
        }
    ...
    public function apply(Zend_Controller_Request_Abstract $request, $filterBlock){
        if (Mage::helper('dgtfilter')->isPriceEnable() && version_compare(Mage::getVersion(), '1.7.0.0') < 0){
            /**
