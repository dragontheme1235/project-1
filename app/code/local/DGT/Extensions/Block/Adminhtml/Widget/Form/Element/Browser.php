...
class DGT_Extensions_Block_Adminhtml_Widget_Form_Element_Browser
    ...
    public function __construct(){
        parent::__construct();
        $this->setTemplate('dgt/extensions/adminhtml/widget/form/element/browser.phtml');
    }
    ...
    protected function _prepareLayout(){
        ...
        $browserBtn = $this->getLayout()->createBlock('adminhtml/widget_button', 'button',  array(
            'label'     => '...',
            'title'     => Mage::helper('dgtext')->__('Click to browser media'),
            'type'      => 'button',
            'onclick'   => sprintf('DGT.MediabrowserUtility.openDialog(\'%s\')',
        ...
        $clearBtn = $this->getLayout()->createBlock('adminhtml/widget_button', 'button',  array(
            'label'     => 'x',
            'title'     => Mage::helper('dgtext')->__('Click to clear value'),
            'type'      => 'button',
