...
class DGT_Extensions_Block_Adminhtml_System_Config_Form_Slider extends Mage_Adminhtml_Block_System_Config_Form_Field{
    protected $element;

    protected function _prepareLayout(){
        $this->setTemplate('dgtext/adminhtml/system/config/form/slider.phtml');
        return $this;
    }
