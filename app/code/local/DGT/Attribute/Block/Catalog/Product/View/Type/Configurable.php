 ...
 */
class DGT_Attribute_Block_Catalog_Product_View_Type_Configurable extends Mage_Catalog_Block_Product_View_Type_Configurable{
    /**
    ...
    public function getJsonConfig(){
        ...
        $config = array_merge(
            ...
            array(
                ...
                'images'    => $images,
                'thumbs'    => $thumbs,
                'show'      => Mage::getStoreConfig('dgtattribute/general/show'),
                'imgWidth'  => is_numeric(Mage::getStoreConfig('dgtattribute/general/width'))?Mage::getStoreConfig('dgtattribute/general/width'):50,
                'czoomRel' => Mage::helper('dgtattribute')->getCloudZoomConfig(true)
            ),
