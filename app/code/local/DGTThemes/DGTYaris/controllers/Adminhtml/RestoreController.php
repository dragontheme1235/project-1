...
?>
<?php
class DGTThemes_DGTYaris_Adminhtml_RestoreController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _isAllowed()
    {
        return Mage::getSingleton('admin/session')
            ->isAllowed('dgtthemes/dgtyaris/restore');
    }

    protected function _initAction()
    {
        $this->loadLayout()
            ->_setActiveMenu('dgtthemes/dgtyaris/restore')
    ...
    {
        $this->_initAction();
        $this->_title($this->__('DGTThemes'))
            ->_title($this->__('DGTYaris'))
            ->_title($this->__('Restore Defaults'));
        $this->_addContent($this->getLayout()->createBlock('dgtyaris/adminhtml_restore_edit'));
        $this->renderLayout();
    }
    ...
    public function restoreAction()
    {
	    ...
	    try {
            ...
            $defaults->loadFile(Mage::getBaseDir().'/app/code/local/DGTThemes/DGTYaris/etc/config.xml');
            $this->_restoreSettings($defaults->getNode('default/dgtyaris_design')->children(), 'dgtyaris_design');
            Mage::getSingleton('adminhtml/session')->addSuccess(
                Mage::helper('adminhtml')->__('Default Settings for DGTYaris Design Theme has been restored.'));
        }
        catch (Exception $e) {
