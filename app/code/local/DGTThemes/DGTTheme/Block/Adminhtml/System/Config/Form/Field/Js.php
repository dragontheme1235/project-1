...
?>
<?php
class DGTThemes_DGTTheme_Block_Adminhtml_System_Config_Form_Field_Js extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element){ 
       	$html = parent::_getElementHtml($element);
        $js = $this->getJsUrl('dgtthemes/jquery/jquery-1.8.2.min.js');
        $colorpicker = $this->getJsUrl('dgtthemes/jquery/plugins/mcolorpicker/');
        $html .= '
